...
> **Status:** v1.0.0 — initial public release. PRs welcome.
>
> **Size:** ~13.7k words / ~22k tokens when loaded. Designed as a comprehensive reference to replace trial-and-error, not a quick overview. If you want stricter triggering for lighter sessions, tighten the frontmatter `description` field in your local copy.
